...
out={'generatedAt':datetime.datetime.now(datetime.timezone.utc).isoformat(),'criteria':'Nur Titel mit AKTScore >=90/100; identisches Scoring aus Adjusted Close, Momentum, RSI, MACD, Volatilität und Volumen. Maximal 10 Titel.','items':items}
